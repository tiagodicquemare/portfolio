...
import 'package:dicquemare_solution/core/carousel/carousel_state.dart';
...
class CarouselSliderState extends State<MyCarouselSlider>
  ...
  Widget getGestureWrapper(BuildContext context, Widget child) {
    Widget wrapper;
              ...
              itemBuilder: (BuildContext context, int idx) {
                ...
                return AnimatedBuilder(
                  ...
                  builder: (BuildContext context, child) {
                    ...
                    if (widget.options.enlargeCenterPage != null &&
                      ...
                      if (position != null &&
                        ...
                        if (_page != null) {
                          ...
                          // Calculate the alignment of the page based on its position.
                          final double page =
                              carouselState?.pageController?.page ??
                                  carouselState!.initialPage.toDouble();
                          alignmentY = page == idx
                              ? 0.0
                              : 1.0; // Center if selected, bottom if not.
                        }
                      } else {
                        ...
                        if (previousSavedPosition != null) {
                          ...
                          itemOffset = carouselState!.realPage.toDouble() -
                              idx.toDouble();
                        }
                      }
                    ...
                    // Apply a transform to the page based on the calculated alignment.
                    return Transform(
                      ...
                      transform: Matrix4.identity()
                        ...
                        ..translate(
                            ...
                            (alignmentY * 100) *
                                (1 -
                                    distortionValue)), // Adjust the 100 value to control the translation distance
                      child: child,
                    );

                    // TODO to handle the enlarge strategy and axis
